 ...
 * Collectives.
 *
 * The Fellowship-side referendum lifecycle (Submitted, DecisionDepositPlaced, Voted, Confirmed)
 * is asserted inside `passFellowshipReferendum` block-by-block, so this test focuses on the
 * cross-chain effect.
 *
